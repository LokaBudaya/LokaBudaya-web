        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    {{-- Ganti route ke 'home' agar logo mengarah ke halaman utama --}}
                    <a href="{{ route('home') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    {{-- Ganti route ke 'home' dan sesuaikan nama --}}
                    <x-nav-link :href="route('home')" :active="request()->routeIs('home')">
                        {{ __('Home') }}
                    </x-nav-link>
                    {{-- Anda bisa menambahkan link lain di sini, contoh: --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    {{-- TAMPILKAN INI JIKA USER ADALAH GUEST --}}
